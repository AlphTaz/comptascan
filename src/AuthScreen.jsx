  ...
  return (
    <div style={{ fontFamily: font, background: palette.bg, color: palette.text, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      ...
      <div style={{ width: "100%", maxWidth: 400, background: palette.surface, borderRadius: 16, border: `1px solid ${palette.border}`, padding: 28 }}>
        ...
        <button onClick={handleEmail} disabled={loading || !email || !password} style={{ width: "100%", padding: "12px", borderRadius: 10, border: "none", background: `linear-gradient(135deg, ${palette.accent}, #2BA86E)`, color: palette.bg, fontSize: 14, fontWeight: 700, fontFamily: font, cursor: loading ? "default" : "pointer", opacity: (!email || !password) ? 0.5 : 1, transition: "all 0.2s" }}>
